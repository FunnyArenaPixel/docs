<template><h1 id="管理层" tabindex="-1"><a class="header-anchor" href="#管理层" aria-hidden="true">#</a> 管理层</h1>
<p>依据《<a href="main">团队总纲</a>》，我们的管理层由以下成员组成。</p>
<table>
  <tr>
...
<p>如果您有任何疑问，欢迎与我们<a href="mailto:admin@fapixel.com">取得联系</a>。</p>
</template>
