 ...
 * documents.
 */
declare const removeAll: <Document_1, ID>(searchIndex: SearchIndex<Document_1, ID>, documents?: readonly Document_1[]) => void;
...
export { type AutoVacuumOptions, type BM25Params, type IndexObject, type LogLevel, type MatchInfo, type Query, type QueryCombination, SearchIndex, type SearchIndexOptions, type SearchOptions, type SearchResult, SearchableMap, type SerializedIndexEntry, type Suggestion, type VacuumConditions, type VacuumOptions, add, addAll, addAllAsync, autoSuggest, createIndex, discard, discardAll, getDefaultValue, getStoredFields, has, loadIndex, loadJSONIndex, remove, removeAll, replace, search, vacuum };
